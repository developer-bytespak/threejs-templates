...
import { hasPref, subscribe, toggleEnabled } from './engine.js'
import './sound-button.css'
...
function SoundButton({ entered = true, className = '' }) {
  ...
  return (
    <span className={`c2snd ${className}`.trim()} data-on={on} data-hint={hint}>
      <button
